...
const C = {
  bgCard: '#181818', bgSubtle: '#141414', border: '#1e1e1e',
  green: '#8fbc8f', textP: '#e8e8e8', textS: '#cccccc', textM: '#666666',
};
    ...
    <div style={{ background: C.bgSubtle, border: `1px solid ${C.border}`, borderRadius: 12, padding: 20 }}>
      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 16 }}>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
          ...
          <button onClick={onNextMonth} disabled={!canGoNext} style={{ background: 'none', border: 'none', color: canGoNext ? C.textM : '#2a2a2a', cursor: canGoNext ? 'pointer' : 'default', fontSize: 16, display: 'flex' }} aria-label="Next month">
